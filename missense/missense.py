...
def gen_image(pos_to_val) -> np.array:
    """ Generates raw image data as numpy array"""
...
def download_missense_data():
    '''
    Download and decompress data to temporary directory.
    '''
            ...
            for line in f:
                if line.startswith("ATOM "):
                    ...
                    while len(value_str) < 6:
                        value_str = " " + value_str
                    edit_line = line[:60] + value_str + line[67:] # replace the temperature factor
